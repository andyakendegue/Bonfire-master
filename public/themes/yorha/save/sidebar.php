<div class="col-md-3">
    ...
    <div class="sidebar">
        ...
        <form method="post" action="#" id="subscribe">
          <p style="padding: 0 0 9px 0;"><input class="search" type="text" name="email_address" value="your email address" onclick="document.forms['subscribe'].email_address.value=''" /></p>
